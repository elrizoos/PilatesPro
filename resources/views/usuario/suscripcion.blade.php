        ...
        <ul class="fs-5 row p-2 fs-5">
            <div class="col-12 d-flex d-md-inline-block justify-content-center align-items-center">
                <li class="contenido-cargable-interno contenido-item text-center p-2 texto-color-secundario"
                    id="estadoSuscripcion" data-url="{{ route('suscripcion-estadoSuscripcion') }}">Estado de suscripcion</li>
            ...
            <div class="col-12">
                <li class="contenido-cargable-interno contenido-item text-center p-2 texto-color-secundario"
                    id="detallesPlan" data-url="{{ route('suscripcion-detallesPlan') }}">
                    Detalles suscripcion</li>
                <li class="contenido-cargable-interno contenido-item text-center p-2 texto-color-secundario"
                    id="historialPago" data-url="{{ route('suscripcion-historialPago') }}">
