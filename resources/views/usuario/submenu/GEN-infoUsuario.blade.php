...
@section('informacionGeneral')
    <form class="col d-flex justify-content-center align-items-center flex-column formulario-dorado" class="formulario" action="{{ route('usuario-guardarCambios') }}">
        <input type="hidden" name="tipo_informacion" value="informacionGeneral">
        <input type="hidden" name="usuario" value="{{ Auth::user()->email }}">
        <div class="row w-50 h-15">
            <div class="col">
                <input class="estilo-formulario-dorado" type="text" name="nombre" id="nombre"
                    value="{{ Auth::user()->nombre }}" placeholder="Nombre">
                <hr class="linea-transition-weigth border border-warning-subtle  border-1 ">
            </div>
            <div class="col">
                <input class="estilo-formulario-dorado" type="text" name="apellidos" id="apellidos"
        ...
        <div class="row w-50 h-15">
            <div class="col">
                <input class="estilo-formulario-dorado" type="date" name="fecha-nacimiento" id="fecha-nacimiento"
                    value="{{ Auth::user()->fecha_nacimiento }}" disabled>
                <hr class="linea-transition-weigth border border-warning-subtle  border-1 ">
            </div>
            <div class="col">
                <input class="estilo-formulario-dorado" type="text" name="dni" id="dni"
