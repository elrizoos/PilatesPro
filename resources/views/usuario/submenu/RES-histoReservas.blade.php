        ...
        @if (isset($reservasPasadas) && isset($reservasFuturas))
            @if ($reservasPasadas->isEmpty() && $reservasFuturas->isEmpty())
                <p class="fs-1 text-warning text-center d-flex flex-column">
                    ...
                    <a class="fs-5 fs-5" href="">Haz click aquí para consultar las clases disponibles para reservar</a>
                </p>
            @else
                        ...
                        <table class="table tabla-dorada w-100 fs-5 bg-color-terciario text-center">
                            <thead>
                                <tr>
                                    ...
                                    <th class="fs-5 texto-color-titulo border border-1 border-fondo">Asistida</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($reservasFuturas as $reserva)
                                    <tr>
                                        <td class="texto-color-resalte border border-1 border-fondo">{{ $reserva->id }}
                                        </td>
