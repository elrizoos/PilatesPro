    ...
    <div class="col col-12 col-lg-3  d-flex justify-content-center align-items-center">
        <ul class="row p-2 fs-5">
            <div class="col-12 d-flex d-lg-inline-block justify-content-center align-items-center">
                <li class="contenido-cargable-interno text-center contenido-item p-2 texto-color-secundario" id="historialReservas"
                    data-url="{{ route('reservas-historialReservas') }}">
                    Historial de reservas</li>
                <li class="contenido-cargable-interno text-center contenido-item p-2 texto-color-secundario" id="reservasActivas"
                    data-url="{{ route('reservas-reservasActivas') }}">
                    Reservas activas</li>
            </div>
            <div class="col-12">
                <li class="contenido-cargable-interno text-center contenido-item p-2 texto-color-secundario" id="sugerenciasReservas"
