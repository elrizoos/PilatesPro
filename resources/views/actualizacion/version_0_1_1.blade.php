...
<ul class="fs-5 lista-cambios">
        ...
        <ul class="fs-5 lista-principal">
            <li class="apartado-principal">Dentro del apartado de "Usuarios":
                <ul>
                    ...
                    <li class="subapartado">Editar un usuario existente que se muestra en una tabla con todos los
                        usuarios.</li>
            ...
            <li class="apartado-principal">Dentro del apartado de "Contenido":
                <ul>
                    <li class="subapartado">Crear una nueva página que aparecerá en un desplegable "Más" en la página de
                        inicio.</li>
                    <li class="subapartado">Crear una nueva sección, elegir la página donde añadir la sección y
                        seleccionar entre cuatro estructuras de contenido la más adecuada.</li>
                    ...
                    <li class="subapartado">Mostrar una galería con las fotos de perfil de los usuarios de la aplicación
                        y las fotos de las secciones.</li>
                </ul>
            </li>
            ...
            <li class="apartado-principal">Dentro del apartado de "Productos":
                <ul>
                    <li class="subapartado">Gestionar productos, tanto paquetes de clases como suscripciones mensuales.
                    </li>
                </ul>
            </li>
        </ul>
    ...
    <li class="cambio cambio-principal">
        ...
        <ul class="fs-5 lista-principal">
            ...
            <li class="apartado-principal">Ver el historial de reservas, incluyendo las activas actualmente y las
                disfrutadas anteriormente.</li>
            <li class="apartado-principal">Ver las reservas actualmente activas para disfrutar en el futuro.</li>
            <li class="apartado-principal">Recibir sugerencias de reservas en clases adecuadas al grupo al que pertenece
                el alumno.</li>
