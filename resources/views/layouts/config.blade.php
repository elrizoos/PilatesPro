...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div hidden>
        <svg xmlns="http://www.w3.org/2000/svg" style="display: none">
            ...
            <symbol id="flecha-recta" viewBox="0 0 512 512">
                ...
                <path
                    d="m512 256-143.542-82.874v60.595H0v44.558h368.458v60.595z"
                    fill="#8e6d45"
                    opacity="1"
                    data-original="#000000"
                />
            ...
            <symbol id="cafetera" viewBox="0 0 64 64">
                ...
                />
                <path
                    d="M20 10a1 1 0 0 1 .293-.707L24.586 5 23 3.414l-5 5V13h2zM33 16a1 1 0 0 0-1-1H6a1 1 0 0 0-1 1v1h28z"
                    fill="#8e6d45"
                    opacity="1"
                    data-original="#000000"
                    class=""
                ...
                />
                <path
                    d="M54 58H28a1 1 0 0 0-1 1 2 2 0 0 0 2 2h24a2 2 0 0 0 2-2 1 1 0 0 0-1-1z"
                    fill="#8e6d45"
                    opacity="1"
                    data-original="#000000"
                    class=""
    ...
    <body class="container-fluid w-100 vh-100 bg-fondo-general">
        <div class="row h-25">
            <div class="col w-100 h-100 p-4">
                <div
                    class="img-fluid imagen-logo w-100 h-100 img"
                    id="imagen-logo"
        ...
        <div class="row h-75 g-0" id="app">
            <div class="col">
                <div
                    class="alertas-flotantes position-fixed top-0 end-0 p-3 z-3"
                    style="min-width: 300px"
                >
                    @if (session('success'))
                    <div
                        class="alert alert-success fade show shadow"
                        role="alert"
                    >
                        {{ session("success") }}
                    </div>
                    ...
                    <div
                        class="alert alert-danger fade show shadow"
                        role="alert"
                    >
                        {{ session("error") }}
                    </div>
                ...
                <div class="row d-none d-md-flex h-15">
                    <ul
                        class="col d-flex gap-5 align-items-center justify-content-center texto-color-dorado text-center text-uppercase"
                    >
                        <li
                            class="contenido-cargable p-4 border border-1 rounded-3 border-fondo border-top-0 border-start-0 border-end-0"
                            id="contenidoGeneral"
                        ...
                        <li
                            class="contenido-cargable p-4 border border-1 rounded-3 border-fondo border-top-0 border-start-0 border-end-0"
                            id="contenidoSuscripcion"
                            data-url="{{
                                route('suscripcion-estadoSuscripcion')
                            }}"
                        >
                            Suscripcion
                        </li>
                        <li
                            class="contenido-cargable p-4 border border-1 rounded-3 border-fondo border-top-0 border-start-0 border-end-0"
                            id="contenidoContrasena"
                            data-url="{{
                                route('contrasena-cambiarContrasena')
                            }}"
                        >
                            Cambiar contraseña
                        </li>
                        <li
                            class="contenido-cargable p-4 border border-1 rounded-3 border-fondo border-top-0 border-start-0 border-end-0"
                            id="contenidoOtros"
                            data-url="{{ route('otros-notificaciones') }}"
                        >
                            Otros ajustes
                        </li>
                    </ul>
                    ...
                    >
                        <div
                            class="w-100 h-100 p-4 d-flex justify-content-center align-items-center gap-2 fs-5 text-capitalize texto-color-resalte"
                        >
                            {{ Auth::user()->nombre }}
                            <svg
                                id="icono-salir"
                                data-url="{{ route('inicio') }}"
                                class="icon icono-normal"
                            >
                ...
                <div
                    class="row g-0 p-0 h-85 position-relative"
                    id="contenido-dinamico"
                    class="contenido-ajustes"
                >
                    <ul
                        id="listaMovil"
                        class="position-absolute end-100 deslizamiento z-2 w-100 h-100 bg-color-principal d-flex d-none flex-column d-md-none gap-5 align-items-center justify-content-center texto-color-dorado text-center text-uppercase"
                    >
                        ...
                        <li
                            class="contenido-cargable p-3 border border-1 rounded-3 border-fondo border-top-0 border-start-0 border-end-0"
                            id="contenidoGeneral"
                            data-url="{{ route('general-informacion') }}"
                        >
                            General
                    ...
                    <div
                        class="col p-0 contenidoGeneral"
                        id="contenedor-contenidoGeneral"
                    >
                    ...
                    <div
                        class="col contenidoReservas"
                        id="contenedor-contenidoReservas"
                    >
                        <div class="row w-100 h-100 g-0">
                    ...
                    <div
                        class="col contenidoSuscripcion"
                        id="contenedor-contenidoSuscripcion"
                    >
                        <div class="row w-100 h-100 g-0">
                    ...
                    <div
                        class="col contenidoContrasena"
                        id="contenedor-contenidoContrasena"
                    >
                        <div class="row w-100 h-100 g-0">
                    ...
                    <div
                        class="col contenidoOtros"
                        id="contenedor-contenidoOtros"
                    >
                        <div class="row w-100 h-100 g-0">
