...
@section('content')
    <div class="vw-100 vh-100 d-flex flex-column justify-content-center align-items-center">
        <div class="w-50 h-75 border border-warning-subtle bg-color-fondo d-flex flex-column justify-content-evenly align-items-center">
            <div class="w-50 h-25">
            ...
            <form class="formulario d-flex flex-column fs-5 w-75" method="POST" action="{{ route('password.update') }}">
                ...
                <div class="form-group mb-3">
                    <input class="form-control estilo-formulario" id="email" type="email" name="email" value="{{ $email ?? old('email') }}"
                ...
                <div class="form-group mb-3">
                    <input class="form-control estilo-formulario" id="password-confirm" type="password" name="password_confirmation" required
