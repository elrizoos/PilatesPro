...
<div class="vw-100 vh-100 d-flex flex-column justify-content-center align-items-center">
    <div class="w-50 h-75 border border-warning-subtle bg-color-fondo-oscuro d-flex flex-column justify-content-evenly align-items-center">
        <div class="w-50 h-25">
        ...
        @if ($errors->any())
                ...
                @endif
            <form class="d-flex flex-column fs-5" action="{{route('login')}}" method="post">
                @csrf
