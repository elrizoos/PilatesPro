...
@section('CONT-crearPagina')
    <div class="container-fluid w-100 h-100">
        <form class="w-100 h-100 container-fluid  fs-5  p-2 d-md-flex flex-column align-items-center justify-content-center"
            ...
            <div class="row">
                <div class="col">
                    <input class="p-1 estilo-formulario w-100 text-center" type="text" name="titulo" id="titulo" placeholder="Título de la página">
                ...
                <div class="col">
                    <input class="p-1 estilo-formulario w-100 text-center" type="text" name="descripcion" id="descripcion" placeholder="Descripción">
                    <hr class="mt-0 w-100 linea-transition-weigth border border-warning-subtle  border-1 ">
