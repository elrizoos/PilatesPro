...
@section('CONT-eliminarEditar')
    <div class=" w-75 h-75 d-flex justify-content-center align-items-center container-fluid" id="contenedorSeleccion">
        ...
        <div class="row w-100 h-100 text-light d-flex gap-3">
            <div class="col  d-flex flex-column justify-content-center align-items-center fs-3 position-relative gap-3 border border-2 border-secondary-subtle rounded-5">
            ...
            <div class="col d-flex flex-column justify-content-center align-items-center fs-3 position-relative gap-3 border border-2 border-secondary-subtle rounded-5">
                ...
                <div class="opcion d-flex justify-content-center align-items-center gap-2 text-warning" id="eliminarSeccion">
                    <svg class="icon icono-normal">
                        <use xlink:href="#eliminar" />
                    </svg>
                    <h3>ELIMINAR</h3>
        ...
        <div class="contenedor-paginas d-none">
            <form class="formulario-pagina" action="" method="POST">
                @csrf
                @method('')
        ...
        <div class="contenedor-secciones d-none">
            <form class="formulario-seccion" action="" method="POST">
                @csrf
                @method('')
                ...
                <input class="estilo-formulario estilo-formulario-enviar w-100" id="boton-seccion" type="submit" value="">
            </form>
        </div>
