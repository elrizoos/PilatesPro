        ...
        <table class="table tabla-dorada w-100 fs-5 bg-color-fondo-muy-oscuro text-center">
            <thead>
                <tr class="text-uppercase">
                    ...
                    <th class="text-light border border-2 border-fondo">Participantes</th>
            ...
            <tbody>
                @foreach ($alumnos as $grupo)
                    <tr class="">
                        <td class="texto-color-dorado border border-2 border-fondo">{{ $grupo['id'] }}</td>
                        <td class="texto-color-dorado border border-2 border-fondo">{{ $grupo['nombreGrupo'] }}</td>
